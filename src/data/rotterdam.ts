...

  {
    ...
    inzichten: [
      ...
      },
      {
        ...
        datum: '2026-05-30',
        categorie: 'marktdynamiek',
        inzicht: 'Twee gebiedsontwikkelingen met kantoorfocus: (1) CBD Schiekeblok nabij Centraal Station, ca. 300.000 m2 gepland maar traag door meerdere eigenaren en aflopende erfpachtcontracten; (2) Marconiplein/Keilenkwartier, mixed-use voor haven- en creatieve sector gecombineerd met een groot woningbouwprogramma.',
      },
      {
        id: 'rc-inz-07',
        bron: 'Maurits de Peuter',
