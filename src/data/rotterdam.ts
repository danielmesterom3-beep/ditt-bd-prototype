...

  {
    ...
    kansrijkeLeads: [
      ...
      },
      {
        ...
        motivatie: 'De Rotterdamsche Werkplaats huurt 345 m² aan de Kaatsbaan, dichtbij Waalhaven. Contract afloop augustus 2026 — urgente lead. Een zakelijke dienstverlener op dit formaat staat op het punt een nieuwe kantoorrichting te kiezen: het ideale moment om een D&B-propositie in te brengen.',
      },
      {
        id: 'ra-lead-04',
        pandnaam: '',
        ...
        huurprijsPerM2: 115,
        contractBegin: '2022-02',
        motivatie: 'UNLP huurt 353 m² in het Van Nelle complex — een van de meest iconische gebouwen van Rotterdam (UNESCO Werelderfgoed). Tech- en creatieve bedrijven in dit gebouw investeren in kantoorconcepten die hun employer brand versterken. Contract afloop februari 2027.',
      },
      {
        id: 'ra-lead-05',
        pandnaam: '',
        ...
        contractBegin: '2022-06',
        eigenaar: 'Havenbedrijf Rotterdam',
        motivatie: 'C.H. Robinson Europe huurt 447 m² aan de Waalhaven, direct aan de grootste haven van Europa. Een logistieke multinational op deze locatie ontvangt internationale havengerelateerde klanten en investeert in een werkplek die die schaal uitstraalt. Eigenaar Havenbedrijf Rotterdam biedt een ingang naar meerdere kantoorobjecten in de havenportefeuille. Contract afloop juni 2027.',
      },
      {
        id: 'ra-lead-06',
        pandnaam: '',
        ...
        motivatie: 'Randstad Groep Nederland huurt 340 m² aan de Waalhaven. Als grootste uitzendbureau van Nederland werkt Randstad met veel fysieke klantcontacten — hun kantooromgeving is een cruciaal onderdeel van het wervingsproces voor kandidaten en opdrachtgevers. Contract afloop mei 2027.',
      },
      {
        id: 'ra-lead-07',
        pandnaam: '',
        ...
        motivatie: 'Trend Advies & Management huurt 222 m² aan de Cairostraat. Eigenaar Pensioenfonds Rail & OV is een institutionele belegger met een brede vastgoedportefeuille — een goede eerste samenwerking hier opent de deur naar meerdere panden. Schaub & Partners en De Mik Real Estate Partners waren beide betrokken als makelaar verhuurder; via beide netwerken is een warme ingang beschikbaar. Contract afloop februari 2027.',
      },
    ] satisfies KansrijkeLead[],
  },
]
