    ...
    pandenInOntwikkeling: [
      {
        id: 'cent-dev-01',
        naam: 'Edge Eindhoven',
        adres: 'Stationsweg 17, 5611AA Eindhoven',
        oppervlakte: 35351,
        fase: 'oplevering',
        verwachteOplevering: '2025',
        ontwikkelaar: 'Edge Technologies',
        toelichting: 'Groot mixed-use kantoorontwikkeling direct bij station; 35.351 m². Grootste kantoorpand in ontwikkeling in geheel Eindhoven (EIND CLUSTER ANA.pdf top-10 #1). Contactpersoon: Constantijn Berning.',
      },
      {
        id: 'cent-dev-02',
        naam: 'Deken van Somerenstraat 4',
        adres: 'Deken van Somerenstraat 4, 5611KX Eindhoven',
        oppervlakte: 22781,
        fase: 'bouw',
        verwachteOplevering: '2021 / opgeleverd',
        toelichting: 'Getransformeerd kantoorpand in centrumgebied.',
      },
      {
        id: 'cent-dev-03',
        naam: 'Lightyards: Highlight & Lumen',
        adres: 'Oude Spoorhof 100, 5611BW Eindhoven',
        oppervlakte: 20949,
        fase: 'bouw',
        verwachteOplevering: '2023 / opgeleverd',
    ...
    pandenInOntwikkeling: [
      {
        ...
        adres: 'Ir. De Broekertstraat 1, 5617BW Eindhoven',
        oppervlakte: 21273,
        fase: 'oplevering',
        verwachteOplevering: '2025',
        toelichting: 'Grootste actieve ontwikkeling op Strijp-S; mixed-use met kantoor- en creatieve werkruimte.',
      },
      {
        id: 'ss-dev-02',
        naam: 'Ketelhuisplein 20',
        adres: 'Ketelhuisplein 20, 5617AE Eindhoven',
        oppervlakte: 6533,
        fase: 'bouw',
        verwachteOplevering: '2024 / afgerond',
        toelichting: 'Herontwikkeling industrieel erfgoed rond het Ketelhuisplein.',
      },
      {
        id: 'ss-dev-03',
        naam: 'Koenraadlaan 110',
        adres: 'Koenraadlaan 110, 5651EZ Eindhoven',
        oppervlakte: 5805,
        fase: 'bouw',
        verwachteOplevering: '2024 / afgerond',
