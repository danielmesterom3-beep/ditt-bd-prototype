  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    inzichten: [
      ...
      },
      {
        ...
        datum: '2026-06-04',
        categorie: 'acquisitie',
        inzicht: 'Geva Vastgoed is bouwondernemer die kantoorinrichtingen volledig zelf realiseert. Als eigenaar en bouwer zijn zij geen zinvol acquisitiedoel voor Ditt. Relevantere ingangen voor het Eindhovense centrumgebied zijn Braintown, NLV en SDK Vastgoed.',
      },
      {
        id: 'fell-inz-07',
        bron: 'Dirk Verberne',
        ...
        datum: '2026-06-04',
        categorie: 'acquisitie',
        inzicht: 'NLV (Nationaal Vastgoed) beheert het Admirant-complex en het OV&D-gebouw in Eindhoven centrum. Beide panden zijn kantoorpanden met gemengd huurdersprofiel en bieden concrete ingang voor Ditt bij contractmutaties.',
      },
      {
        id: 'fell-inz-08',
        bron: 'Dirk Verberne',
        ...
        datum: '2026-06-04',
        categorie: 'inrichting',
        inzicht: 'Huurders van tweede bezichtiging af willen weten wat totale inrichtingskosten zijn, inclusief afbouw, want die moeten in de huurtermijn worden terugverdiend. In het pitchgesprek: altijd meteen het totaalplaatje (huur + inrichting / looptijd) neerzetten als kapstok.',
      },
    ],
    partijen: [
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    inzichten: [
      ...
      },
      {
        ...
        datum: '2026-06-04',
        categorie: 'acquisitie',
        inzicht: '3 Capital Management is de eigenaar van Hightech Campus Eindhoven. Voor Ditt is de gebruikersmarkt (toeleveranciers die buiten de campus huisvesting zoeken) relevanter dan de campus-eigenaar als acquisitie-ingang.',
      },
    ],
    partijen: [
